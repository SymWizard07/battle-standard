...
export function HeartIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M19.5 7.5c0 4.5-7.5 11-7.5 11S4.5 12 4.5 7.5a4 4 0 0 1 7.5-2.5 4 4 0 0 1 7.5 2.5Z" />
    </svg>
  );
}

/** Six-dot grip for drag reordering (2×3). */
export function GripDotsIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 10 16" className={className} fill="currentColor" aria-hidden>
...
export function SortDescendingIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
...
export function EyedropperIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="m15 5 4 4 2.5-2.5a2.12 2.12 0 0 0-3-3L15 5Z" />
    </svg>
  );
}
